...
test('文档里的步骤1下载入口使用 HTML 预览下载页', () => {
  ...
  const downloadUrl = /https:\/\/htmlpreview\.github\.io\/\?https:\/\/github\.com\/loqwe\/heyun-zjmf-worker-monitor\/blob\/main\/download-step1\.html/;
