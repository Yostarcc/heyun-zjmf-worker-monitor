...
1. Fork 本仓库。
2. [点击下载：步骤1-一键安装脚本](https://htmlpreview.github.io/?https://github.com/loqwe/heyun-zjmf-worker-monitor/blob/main/download-step1.html)，保存到你想部署的目录。
   点击后会打开下载页，并自动保存为 `步骤1-一键安装脚本.bat`。
